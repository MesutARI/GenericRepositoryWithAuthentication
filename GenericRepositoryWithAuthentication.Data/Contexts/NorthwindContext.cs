...
namespace GenericRepositoryWithAuthentication.Data.Contexts
{
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer((BaseClass.Configuration.GetConnectionString("NorthwindConnectionString")));
                optionsBuilder.UseSqlServer("Server=MESUT_DELL; Database=Northwind; Trusted_Connection=True; MultipleActiveResultSets=true");
            }
        }
