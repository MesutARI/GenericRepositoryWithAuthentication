...
{
	public partial class OrderSubtotalRepository : GenericRepository<OrderSubtotal>, IOrderSubtotalRepository
    {
		public OrderSubtotalRepository(NorthwindContext context) : base(context)
        {
        }
